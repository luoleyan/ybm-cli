    ...
    const templates = fs.readdirSync(templatesDir)
      ...
      .map(dir => {
        ...
        switch(dir) {
          case 'vue3-vite':
            name = 'Vue 3 + Vite';
            description = '基于Vue 3和Vite的项目模板 (JavaScript)';
            break;
          case 'vue3-vite-ts':
            name = 'Vue 3 + TypeScript + Vite';
            description = '基于Vue 3、TypeScript和Vite的项目模板';
            break;
          case 'vue2-webpack':
            name = 'Vue 2 + Webpack';
            description = '基于Vue 2和Webpack的项目模板 (JavaScript)';
            break;
          case 'vue2-webpack-ts':
            name = 'Vue 2 + TypeScript + Webpack';
            description = '基于Vue 2、TypeScript和Webpack的项目模板';
            break;
          case 'react':
            name = 'React';
            description = '基于React和Vite的项目模板 (JavaScript)';
            break;
          case 'react-ts':
            name = 'React + TypeScript';
            description = '基于React、TypeScript和Vite的项目模板';
            break;
          case 'svelte':
            name = 'Svelte';
            description = '基于Svelte和Vite的项目模板 (JavaScript)';
            break;
          case 'svelte-ts':
            name = 'Svelte + TypeScript';
            description = '基于Svelte、TypeScript和Vite的项目模板';
            break;
          case 'solidjs':
            name = 'SolidJS';
            description = '基于SolidJS和Vite的项目模板 (JavaScript)';
            break;
          case 'solidjs-ts':
            name = 'SolidJS + TypeScript';
            description = '基于SolidJS、TypeScript和Vite的项目模板';
            break;
          default:
      ...
      if (!requiredVersion.includes('>') && !requiredVersion.includes('<') && !requiredVersion.includes('~') && !requiredVersion.includes('^')) {
        if (process.version !== `v${requiredVersion}`) {
          throw new Error(
            ...
            `由于依赖包的兼容性要求，必须使用精确的Node.js版本。\n` +
            `请访问 https://nodejs.org/download/release/v${requiredVersion}/ 下载指定版本，\n` +
            `或者使用 nvm install ${requiredVersion} 和 nvm use ${requiredVersion} 切换版本。`
          );
        }
      }
