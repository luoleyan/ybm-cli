...
const toolsConfig = {
  ...
  linter: {
    ...
    choices: [
      ...
      },
      {
        ...
        packages: ['eslint', 'eslint-config-airbnb-base', 'eslint-plugin-import']
      },
      {
        name: 'ESLint + Standard配置',
        value: 'eslint-standard',
        description: '使用Standard风格指南的ESLint配置',
        packages: ['eslint', 'eslint-config-standard', 'eslint-plugin-import', 'eslint-plugin-node', 'eslint-plugin-promise']
      },
      {
        name: '不使用',
        value: 'none',
  ...
  formatter: {
    ...
    choices: [
      ...
      },
      {
        ...
        packages: ['prettier', 'eslint-plugin-prettier', 'eslint-config-prettier']
      },
      {
        name: '不使用',
        value: 'none',
  ...
  typescript: {
    ...
    packages: {
      'vue3-vite': ['typescript', '@vue/tsconfig', 'vue-tsc'],
      'vue2-webpack': ['typescript', '@vue/cli-plugin-typescript', '@typescript-eslint/eslint-plugin', '@typescript-eslint/parser'],
      'react': ['typescript', '@types/react', '@types/react-dom'],
      'svelte': ['typescript', '@tsconfig/svelte', 'svelte-check', 'svelte-preprocess'],
    ...
    choices: [
      ...
      },
      {
        ...
        packages: {
          ...
          'react': ['vitest', '@testing-library/react', '@testing-library/jest-dom'],
          'svelte': ['vitest', '@testing-library/svelte'],
          'solidjs': ['vitest', 'solid-testing-library', '@testing-library/jest-dom']
        }
      },
      {
        name: '不使用',
